...
namespace Retailer.Web.Pages.PurchaseReturn
{
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            Purchase = await _api.GetPurchaseReturnByIdAsync(id); // fetch DTO from API
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            Purchase.Details.ForEach(d =>
            {
                ...
                d.PurchaseReturnId = Purchase.Id;
            });
            var success = await _api.UpdatePurchaseReturnAsync(Purchase); // call Update API
            if (!success)
            {
