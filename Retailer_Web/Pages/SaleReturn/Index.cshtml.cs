...
namespace Retailer.Web.Pages.SaleReturn
{
    public class IndexModel : PageModel
    {
        ...
        [BindProperty]
        public List<SalesMasterReturnDto> Sales { get; set; } = new();
        [BindProperty]
        ...
        public async Task OnGetAsync()
        {
            ...
            #region sales
            Sales = (await _api.GetAllSaleReturnDateWise(sdate, edate)).ToList();
            #endregion
        ...
        public async Task<IActionResult> OnPostCancelSale(int id)
        {
            ...
            var aa = await _api.DeleteSaleReturnAsync(id);
            //// Find the sale by id
