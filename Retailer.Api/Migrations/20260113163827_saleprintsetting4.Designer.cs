...
namespace Retailer.Api.Migrations
{
    ...
    [Migration("20260113163827_saleprintsetting4")]
    partial class saleprintsetting4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Retailer.Api.Entities.Ledger.ItemLedger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Retailer.Api.Entities.SaleInvoiceSettings", b =>
                {
                    ...
                    b.Property<int?>("Footer1Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Footer1Padding")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Footer2Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Footer2Padding")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Footer3Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Footer3Padding")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Header1Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Header1Padding")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Header2Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Header2Padding")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Header3Margin")
                        .HasColumnType("int");

                    b.Property<int?>("Header3Padding")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Retailer.POS.Api.Entities.SalesReturnDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Retailer.POS.Api.Entities.SalesReturnMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Retailer.POS.Api.Entities.SalesReturnDetail", b =>
                {
                    b.HasOne("Retailer.POS.Api.Entities.SalesReturnMaster", "SalesReturnMaster")
                        .WithMany("Details")
                        .HasForeignKey("SalesReturnMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SalesReturnMaster");
                });
