    ...
    private async Task<List<ParsedRow>> ParseRowsAsync(Stream stream, CancellationToken cancellationToken)
    {
        ...
        while ((line = await reader.ReadLineAsync()) != null)
        {
            ...
            var row = new ParsedRow
            {
                ...
                Group = GetColumnValue(values, headerMap, "GroupName", "Groups", "GroupName", "Group Name"),
                SubGroup = GetColumnValue(values, headerMap, "SubGroupName", "SubGroups", "Sub Group", "Subgroup", "Subgroups"),
                ItemType = GetColumnValue(values, headerMap, "ItemTypeName", "Item Type", "Type"),
