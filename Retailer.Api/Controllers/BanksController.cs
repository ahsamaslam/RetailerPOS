...
namespace Retailer.Api.Controllers
{
    ...
    public class BanksController : ControllerBase
    {
        ...
        {
            var list = await _uow.Banks.GetAllAsync(b=>b.CompanyId == CompanyId);
            return Ok(list);
        }
        ...
        {
            var entity = await _uow.Banks.GetAsync(b => b.Id == id);
        ...
        {
            var existing = await _uow.Banks.GetAsync(b => b.Id == Id);
