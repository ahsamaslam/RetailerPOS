...
namespace Retailer.Api.Controllers
{
    ...
    public class ItemTypeController : ControllerBase
    {
        ...
        {
            var list = await _uow.ItemTypes.GetAllAsync(b => b.CompanyId == CompanyId);
            return Ok(list);
        }
        ...
        {
            var entity = await _uow.ItemTypes.GetAsync(b => b.Id == id);
        ...
        {
            var existing = await _uow.ItemTypes.GetAsync(b => b.Id == id);
