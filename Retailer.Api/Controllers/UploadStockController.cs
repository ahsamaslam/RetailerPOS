...
[ApiController]
[Route("api/upload-stock")]
[Authorize(Roles = "admin,superadmin")]
public class UploadStockController : ControllerBase
{
    private readonly IUploadStockService _service;
    private readonly ILogger<UploadStockController> _logger;

    public UploadStockController(IUploadStockService service, ILogger<UploadStockController> logger)
    {
        _service = service;
        _logger = logger;
    }
