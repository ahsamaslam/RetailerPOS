        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NTN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    STRN = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    logoPath = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ContactEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ContactPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    fbrActive = table.Column<bool>(type: "bit", nullable: false),
                    pralToken = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Province = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    fbrToken = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    invoiceCounter = table.Column<int>(type: "int", nullable: false),
                    invoicePerPage = table.Column<int>(type: "int", nullable: false),
                    isGst = table.Column<bool>(type: "bit", nullable: false),
                    gstVal = table.Column<double>(type: "float", nullable: false),
                    isEd = table.Column<bool>(type: "bit", nullable: false),
                    edVal = table.Column<double>(type: "float", nullable: false),
                    isFed = table.Column<bool>(type: "bit", nullable: false),
                    fedVal = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerRegistrationType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioMaster", x => x.ScenarioId);
                });
